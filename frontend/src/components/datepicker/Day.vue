<template >
  <div>
    ...
    <div class="datepicker__month-day" @click.prevent.stop="dayClicked(date)" @keyup.enter.prevent.stop="dayClicked(date)" v-text="dayNumber" :class="dayClass" :style="isToday ? currentDateStyle : &quot;&quot;" :tabindex="tabIndex" ref="day"></div>
</div>
</template>
    ...
    dayClass(){
      if (this.belongsToThisMonth) {
        ...
        if ( this.checkOut !== null ) {
          if ( moment(this.checkOut).format('YYYYMMDD') == moment(this.date).format('YYYYMMDD') ) {
